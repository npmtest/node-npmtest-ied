...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ied/node_modules/ied/lib/init_cmd.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ied/node_modules/ied/lib/init_cmd.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ied/node_modules/ied/lib/</a> &#187; init_cmd.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function initCmd(cwd) {</span>
<span class="cstat-no" title="statement not covered" >	var initFile = _path2.default.resolve(config.home, '.ied-init');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	(0, _initPackageJson2.default)(cwd, initFile, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >		if (err) {</span>
<span class="cstat-no" title="statement not covered" >			if (err.message === 'canceled') {</span>
<span class="cstat-no" title="statement not covered" >				console.log('init canceled!');</span>
