...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ied/node_modules/ied/lib/config_cmd.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ied/node_modules/ied/lib/config_cmd.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ied/node_modules/ied/lib/</a> &#187; config_cmd.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function configCmd() {</span>
<span class="cstat-no" title="statement not covered" >	var table = new _easyTable2.default();</span>
<span class="cstat-no" title="statement not covered" >	var keys = Object.keys(config);</span>
...
<span class="cstat-no" title="statement not covered" >		for (var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
...
<span class="cstat-no" title="statement not covered" >			table.cell('key', key);</span>
<span class="cstat-no" title="statement not covered" >			table.cell('value', value);</span>
<span class="cstat-no" title="statement not covered" >			table.newRow();</span>
		}
	} catch (err) {
