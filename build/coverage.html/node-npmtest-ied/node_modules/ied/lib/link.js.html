...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ied/node_modules/ied/lib/link.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ied/node_modules/ied/lib/link.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ied/node_modules/ied/lib/</a> &#187; link.js</div>
</div>
<div class="body">
 ...
 * created.
 */
<span class="fstat-no" title="function not covered" >function getSymlinks(cwd, pkgJson) {</span>
<span class="cstat-no" title="statement not covered" >  var libSymlink = [cwd, _path2.default.join(config.globalNodeModules, pkgJson.name)];</span>
<span class="cstat-no" title="statement not covered" >  var bin = pkgJson.bin;</span>
<span class="cstat-no" title="statement not covered" >  if (typeof bin === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    bin = {};</span>
<span class="cstat-no" title="statement not covered" >    bin[pkgJson.name] = pkgJson.bin;</span>
  }
<span class="cstat-no" title="statement not covered" >  bin = bin || {};</span>
<span class="cstat-no" title="statement not covered" >  var binSymlinks = Object.keys(bin).map(<span class="fstat-no" title="function not covered" >function (name) {</span></span>
<span class="cstat-no" title="statement not covered" >    return [_path2.default.join(config.globalNodeModules, pkgJson.name, bin[name]), _path2.default.join(config.globalBin, name)];</span>
  });
<span class="cstat-no" title="statement not covered" >  return [libSymlink].concat(binSymlinks);</span>
}
&nbsp;
/*
 ...
 */
<span class="fstat-no" title="function not covered" >function linkToGlobal(cwd) {</span>
<span class="cstat-no" title="statement not covered" >  var _context;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (_context = (_context = (0, _util.readFileJSON)(_path2.default.join(cwd, 'package.json')), _mergeMap.mergeMap).call(_context, <span class="fstat-no" title="function not covered" >function (pkgJson) {</span></span>
<span class="cstat-no" title="statement not covered" >    return getSymlinks(cwd, pkgJson);</span>
  }), _mergeMap.mergeMap).call(_context, <span class="fstat-no" title="function not covered" >function (_ref) {</span>
<span class="cstat-no" title="statement not covered" >    var _ref2 = _slicedToArray(_ref, 2),</span>
        src = _ref2[0],
        dst = _ref2[1];
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _util.forceSymlink)(src, dst);</span>
  });
}
&nbsp;
/**
 ...
 * @return {Observable} - observable sequence.
 */
<span class="fstat-no" title="function not covered" >function linkFromGlobal(cwd, name) {</span>
<span class="cstat-no" title="statement not covered" >  var dst = _path2.default.join(cwd, 'node_modules', name);</span>
<span class="cstat-no" title="statement not covered" >  var src = _path2.default.join(config.globalNodeModules, name);</span>
<span class="cstat-no" title="statement not covered" >  return (0, _util.forceSymlink)(src, dst);</span>
}
&nbsp;
/**
 ...
 * @return {Observable} - observable sequence.
 */
<span class="fstat-no" title="function not covered" >function unlinkToGlobal(cwd) {</span>
<span class="cstat-no" title="statement not covered" >  var _context2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var pkg = require(_path2.default.join(cwd, 'package.json'));</span>
<span class="cstat-no" title="statement not covered" >  var symlinks = getSymlinks(cwd, pkg);</span>
<span class="cstat-no" title="statement not covered" >  return (_context2 = _ArrayObservable.ArrayObservable.create(symlinks), _mergeMap.mergeMap).call(_context2, <span class="fstat-no" title="function not covered" >function (_ref3) {</span></span>
<span class="cstat-no" title="statement not covered" >    var _ref4 = _slicedToArray(_ref3, 2),</span>
        src = _ref4[0],
        dst = _ref4[1];
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _util.unlink)(dst);</span>
  });
}
&nbsp;
/**
 ...
 * @return {Observable} - observable sequence.
 */
<span class="fstat-no" title="function not covered" >function unlinkFromGlobal(cwd, name) {</span>
<span class="cstat-no" title="statement not covered" >  var dst = _path2.default.join(cwd, 'node_modules', name);</span>
<span class="cstat-no" title="statement not covered" >  return (0, _util.unlink)(dst);</span>
}
&nbsp;</pre></td></tr>
